package com.yukti.jobscheduler.jobs;
...
import com.yukti.jobscheduler.services.backup.TriggerBackupService;
...
public class CronJob extends QuartzJobBean implements InterruptableJob{
	...
	@Autowired
	TriggerBackupService triggerBackupService;
	...
	protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		triggerBackupService.triggerBackup(key.getName());
		
		System.out.println("======================================");
		
		//*********** For retrieving stored key-value pairs ***********/
		JobDataMap dataMap = jobExecutionContext.getMergedJobDataMap();
		String myValue = dataMap.getString("backupJobId");
